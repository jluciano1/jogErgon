...
--      v_texto:=v_texto||'Núm. funcionários:      '||to_char(v_numero_funcionarios,'B999999999999999')||' '||to_char(':block_carga_aux.numero_funcionarios','B9999999999999999999999')||chr(10);
  ...
  *******************************************************************************
  * FUNCTION LE_ARQUIVO
  *   Função carregar o arquivo de carga para a tabela temporária CARGA_CAPACIT_TEMP,
...
--    end if;
  ...
  */
  ...
  begin
    ...
    grava_mensagem (v_chave_log, 'Apagando os registros da tabela temporária CARGA_CAPACIT_TEMP.');
    --
    ...
    --
    COMMIT;
    grava_mensagem (v_chave_log, 'Fim da exclusão dos registros da tabela temporária CARGA_CAPACIT_TEMP.');
    --
