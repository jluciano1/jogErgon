...
SELECT 'ttgrj_dml_rjadm00068_Gerar', 'Realiza o cadastro ou atualização de calculos retroativos atravez do btn na tela', '', '', '', '', '', '', '', '', '', '', 'RJERGNG', 'N', 'N', 'Pensão Alimenticia Especial', 'C_Ergon', 'B' FROM DUAL
) TEMP_20170803150253
