...
SELECT 'ttgrj_dml_rjadm00068', 'Realiza o cadastro ou atualização nas tabelas REGRAS_PENSAO e PGOV_SALDO_BLOQ_MS605 inserindo informações referente a pensão especial', '', '', '', '', '', '', '', '', '', '', 'RJERGNG', 'N', 'N', 'Pensão Especial', 'C_Ergon', 'B' FROM DUAL
) TEMP_20170803150253
