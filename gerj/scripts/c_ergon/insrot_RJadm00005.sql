...
SELECT 'PGOV_ASSOCIA_CARGO_DISCIP', 'Rotina de Combinação de Cargos válidos à Categoria e Subcategoria informada', '', '', '', '', '', '', '', '', '', '', 'RJERGNG', 'N', 'N', 'Combina Cargos a Categoria', 'C_Ergon', 'B' FROM DUAL
) TEMP_20160923101539
