...
SELECT 'N', 'TTGRJ_EPB__DEPENDENCIAS', 'S', TO_NUMBER('1'), 'BEGIN'||CHR(10)||' IF TTGRJ_EPB__DEPENDENCIAS(PCK_DEPENDENCIAS.V_ROW_NEW,PCK_DEPENDENCIAS.V_ROW_OLD,:1=''S'',:2=''S'',:3=''S'',:4) THEN '||CHR(10)||'   :5 := ''S'';'||CHR(10)||' ELSE '||CHR(10)||'   :5 := ''N''; '||CHR(10)||' END IF;'||CHR(10)||'END;', 'EPB__DEPENDENCIAS' FROM DUAL
) TEMP_20160901155631
