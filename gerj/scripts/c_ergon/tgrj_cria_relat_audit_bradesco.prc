CREATE OR REPLACE PROCEDURE tgrj_cria_relat_audit_bradesco(
...
BEGIN
  ...
  LOOP
    ...
    --tgrj_relat_util.gera_req_agenda_rep(1,p_usuario,p_relatorio(i),sysdate,p_empresa,1,p_arquivo,arr_param,arr_valor,v_mens);
