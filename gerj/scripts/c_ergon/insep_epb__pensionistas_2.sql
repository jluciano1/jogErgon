...
SELECT 'N', 'TGRJ_EPB__PENSIONISTAS_2', 'S', TO_NUMBER('1'), 'BEGIN'||CHR(10)||' IF TGRJ_EPB__PENSIONISTAS_2(PCK_PENSIONISTAS.V_ROW_NEW,PCK_PENSIONISTAS.V_ROW_OLD,:1=''S'',:2=''S'',:3=''S'',:4) THEN '||CHR(10)||'   :5 := ''S'';'||CHR(10)||' ELSE '||CHR(10)||'   :5 := ''N''; '||CHR(10)||' END IF;'||CHR(10)||'END;', 'EPB__PENSIONISTAS' FROM DUAL
) TEMP_20160901155631
